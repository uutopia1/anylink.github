...
/**
 * @file              hwgi.o28.mem.txGrp_1000.tx_210.ResponseXML.java
...
public class ResponseXML extends com.tmax.promapper.engine.base.XMLMessage implements ResourceMeta {
    ...
    public byte[] marshalObject(Object obj, boolean writeXMLProcessingInstruction, boolean selfCloseFlag) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Response  _responseXML = (hwgi.o28.mem.txGrp_1000.tx_210.Response)obj;
    ...
    public void marshalObject(Object dataObject, XMLStreamWriter writer, QName rootElementName) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Response _responseXML = (hwgi.o28.mem.txGrp_1000.tx_210.Response)dataObject;
     ...
     *
     */
    public void marshalXmlBody(hwgi.o28.mem.txGrp_1000.tx_210.Response _responseXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
    
        marshalXmlBody_0(_responseXML, writer);
    }
    
    private void marshalXmlBody_0(hwgi.o28.mem.txGrp_1000.tx_210.Response _responseXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
        char[] c = null;
        ...
        if(_responseXML.getBody() == null || _responseXML.sizeBody() == 0) {
            //minOccurs == 0, nothing to do.
        } else {
            hwgi.o28.mem.txGrp_1000.tx_210.BodyXML bodyMessage = new hwgi.o28.mem.txGrp_1000.tx_210.BodyXML();
            ...
            int size =    _responseXML.sizeBody();
            for(int i = 0; i < size; i++) {
                if(_responseXML.getBody(i) != null) {
            ...
            if (isRPCEncoded) {
                ...
                writer.writeNamespace("body", "");
                    ...
                    bodyMessage.marshalXmlBody(_responseXML.getBody(i), writer);
                    writer.writeEndElement();
                }
            }
            ...
            if (isRPCEncoded) {
                ...
                writer.writeNamespace("body", "");
                    ...
                    bodyMessage.marshalXmlBody(new hwgi.o28.mem.txGrp_1000.tx_210.Body(), writer);
                    writer.writeEndElement();
                }  
            }
        }
    ...
    public void marshalObjectExceptRootElement(Object obj, XMLStreamWriter writer) throws Exception {
        ...
        public void setSimpleTypeField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Response _argStructure) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
        ...
        public void setSimpleTypeField_0(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Response _argStructure, String value) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
     ...
     */
    public void setComplexTypeField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Response _argStructure) throws Exception{
        boolean isNil = false;
        if(customHandlerFieldMap.get(_argElementName) != null) {
            ...
            switch(_argFieldIndex) {
            case 5:
                hwgi.o28.mem.txGrp_1000.tx_210.BodyXML _body = new hwgi.o28.mem.txGrp_1000.tx_210.BodyXML();
                hwgi.o28.mem.txGrp_1000.tx_210.Body body_struct = new hwgi.o28.mem.txGrp_1000.tx_210.Body();
                {
							isNil = _body.unmarshalObject(_argReader, body_struct, _argElementName);
                    _argStructure.addBody(body_struct);
    ...
    public void setAttributeField(QName attrName, String attrValue, hwgi.o28.mem.txGrp_1000.tx_210.Response _argStructure) throws  UnmarshallException {
    ...
    public boolean setAttribute(QName _argElementName, QName attrName, String value, hwgi.o28.mem.txGrp_1000.tx_210.Response _argStructure) throws  UnmarshallException{
        // xsi:nil처리
    ...
    public boolean setCustomHandlerField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Response _argStructure) throws Exception{
        switch(_argFieldIndex) {
        default:
            if (!this.ignoreUnknownFields) {
                throw new UnmarshallException("cannot find structureField corresponding to element named, " + _argElementName.toString());
    ...
    public boolean unmarshalObject(XMLStreamReader reader, Object object, QName rootElement) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Response  _responseXML = (hwgi.o28.mem.txGrp_1000.tx_210.Response)object;
    ...
    */
    public Object unmarshalObject(byte[] msg, int offset) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Response  struct = new hwgi.o28.mem.txGrp_1000.tx_210.Response();
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hwgi.o28.mem.txGrp_1000.tx_210:ResponseXML.msg";
