...
/**
 * @file              hwgi.o28.mem.txGrp_1000.tx_210.BodyXML.java
...
public class BodyXML extends com.tmax.promapper.engine.base.XMLMessage implements ResourceMeta {
    ...
    public byte[] marshalObject(Object obj, boolean writeXMLProcessingInstruction, boolean selfCloseFlag) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Body  _bodyXML = (hwgi.o28.mem.txGrp_1000.tx_210.Body)obj;
    ...
    public void marshalObject(Object dataObject, XMLStreamWriter writer, QName rootElementName) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Body _bodyXML = (hwgi.o28.mem.txGrp_1000.tx_210.Body)dataObject;
     ...
     *
     */
    public void marshalXmlBody(hwgi.o28.mem.txGrp_1000.tx_210.Body _bodyXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
    
        marshalXmlBody_0(_bodyXML, writer);
    }
    
    private void marshalXmlBody_0(hwgi.o28.mem.txGrp_1000.tx_210.Body _bodyXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
        char[] c = null;
    ...
    public void marshalObjectExceptRootElement(Object obj, XMLStreamWriter writer) throws Exception {
        ...
        public void setSimpleTypeField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Body _argStructure) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
        ...
        public void setSimpleTypeField_0(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Body _argStructure, String value) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
     ...
     */
    public void setComplexTypeField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Body _argStructure) throws Exception{
        boolean isNil = false;
    ...
    public void setAttributeField(QName attrName, String attrValue, hwgi.o28.mem.txGrp_1000.tx_210.Body _argStructure) throws  UnmarshallException {
    ...
    public boolean setAttribute(QName _argElementName, QName attrName, String value, hwgi.o28.mem.txGrp_1000.tx_210.Body _argStructure) throws  UnmarshallException{
        // xsi:nil처리
    ...
    public boolean setCustomHandlerField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Body _argStructure) throws Exception{
        switch(_argFieldIndex) {
        default:
            if (!this.ignoreUnknownFields) {
                throw new UnmarshallException("cannot find structureField corresponding to element named, " + _argElementName.toString());
    ...
    public boolean unmarshalObject(XMLStreamReader reader, Object object, QName rootElement) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Body  _bodyXML = (hwgi.o28.mem.txGrp_1000.tx_210.Body)object;
    ...
    */
    public Object unmarshalObject(byte[] msg, int offset) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Body  struct = new hwgi.o28.mem.txGrp_1000.tx_210.Body();
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hwgi.o28.mem.txGrp_1000.tx_210:BodyXML.msg";
