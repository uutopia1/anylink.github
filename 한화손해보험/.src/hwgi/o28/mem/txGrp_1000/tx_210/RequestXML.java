...
/**
 * @file              hwgi.o28.mem.txGrp_1000.tx_210.RequestXML.java
...
public class RequestXML extends com.tmax.promapper.engine.base.XMLMessage implements ResourceMeta {
    ...
    public byte[] marshalObject(Object obj, boolean writeXMLProcessingInstruction, boolean selfCloseFlag) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Request  _requestXML = (hwgi.o28.mem.txGrp_1000.tx_210.Request)obj;
    ...
    public void marshalObject(Object dataObject, XMLStreamWriter writer, QName rootElementName) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Request _requestXML = (hwgi.o28.mem.txGrp_1000.tx_210.Request)dataObject;
     ...
     *
     */
    public void marshalXmlBody(hwgi.o28.mem.txGrp_1000.tx_210.Request _requestXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
    
        marshalXmlBody_0(_requestXML, writer);
    }
    
    private void marshalXmlBody_0(hwgi.o28.mem.txGrp_1000.tx_210.Request _requestXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
        char[] c = null;
        ...
        writer.writeCharacters(Long.toString(_requestXML.getPlatGbCd()));
        writer.writeEndElement();
        ...
        writer.writeCharacters(Long.toString(_requestXML.getBun()));
        writer.writeEndElement();
        ...
        writer.writeCharacters(Long.toString(_requestXML.getNaMainBun()));
        writer.writeEndElement();
        ...
        writer.writeCharacters(Long.toString(_requestXML.getNaSubBun()));
        writer.writeEndElement();
    }
    ...
    public void marshalObjectExceptRootElement(Object obj, XMLStreamWriter writer) throws Exception {
        ...
        public void setSimpleTypeField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Request _argStructure) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
        ...
        public void setSimpleTypeField_0(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Request _argStructure, String value) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
            ...
            try{
                ...
                case 6:
                    ...
                    break;
                case 7:
                    _argStructure.setPlatGbCd(value == null || value.length() == 0 ? 0 : Long.parseLong(value));
                    break;
                case 8:
                    _argStructure.setBun(value == null || value.length() == 0 ? 0 : Long.parseLong(value));
                    break;
                case 9:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    _argStructure.setNaMainBun(value == null || value.length() == 0 ? 0 : Long.parseLong(value));
                    break;
                case 14:
                    _argStructure.setNaSubBun(value == null || value.length() == 0 ? 0 : Long.parseLong(value));
                    break;
                default:
     ...
     */
    public void setComplexTypeField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Request _argStructure) throws Exception{
        boolean isNil = false;
    ...
    public void setAttributeField(QName attrName, String attrValue, hwgi.o28.mem.txGrp_1000.tx_210.Request _argStructure) throws  UnmarshallException {
    ...
    public boolean setAttribute(QName _argElementName, QName attrName, String value, hwgi.o28.mem.txGrp_1000.tx_210.Request _argStructure) throws  UnmarshallException{
        // xsi:nil처리
    ...
    public boolean setCustomHandlerField(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.txGrp_1000.tx_210.Request _argStructure) throws Exception{
        switch(_argFieldIndex) {
        default:
            if (!this.ignoreUnknownFields) {
                throw new UnmarshallException("cannot find structureField corresponding to element named, " + _argElementName.toString());
    ...
    public boolean unmarshalObject(XMLStreamReader reader, Object object, QName rootElement) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Request  _requestXML = (hwgi.o28.mem.txGrp_1000.tx_210.Request)object;
    ...
    */
    public Object unmarshalObject(byte[] msg, int offset) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Request  struct = new hwgi.o28.mem.txGrp_1000.tx_210.Request();
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hwgi.o28.mem.txGrp_1000.tx_210:RequestXML.msg";
