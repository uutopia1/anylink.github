...
/**
 * @file              hwgi.o28.mem.txGrp_1000.tx_210.Request.java
...
public class Request extends ProMapperDataObject implements ResourceMeta {
    ...
    private long platGbCd;
    
    public long getPlatGbCd() {
        return platGbCd;
    }

    public String getPlatGbCd(boolean _masked) {
        return String.valueOf(getPlatGbCd());
    }
                      
    public void setPlatGbCd(long platGbCd) {
        this.platGbCd = platGbCd;
        _setFlag = true;
    }

    public void setPlatGbCd(long platGbCd, boolean _masked) {
    ...
    public String getBun(boolean _masked) {
        return String.valueOf(getBun());
    }
                      
    public void setBun(long bun) {
        this.bun = bun;
        _setFlag = true;
    }

    public void setBun(long bun, boolean _masked) {
        setBun(bun);
    }
    ...
    private long naMainBun;
    
    public long getNaMainBun() {
        return naMainBun;
    }

    public String getNaMainBun(boolean _masked) {
        return String.valueOf(getNaMainBun());
    }
                      
    public void setNaMainBun(long naMainBun) {
        this.naMainBun = naMainBun;
        _setFlag = true;
    }

    public void setNaMainBun(long naMainBun, boolean _masked) {
        setNaMainBun(naMainBun);
    }


            
    private long naSubBun;
    
    public long getNaSubBun() {
        return naSubBun;
    }

    public String getNaSubBun(boolean _masked) {
        return String.valueOf(getNaSubBun());
    }
                      
    public void setNaSubBun(long naSubBun) {
        this.naSubBun = naSubBun;
        _setFlag = true;
    }

    public void setNaSubBun(long naSubBun, boolean _masked) {
...
/*    static {
    ...
    public Object get(String fieldName) {
        ...
        switch(hashCode) {
            ...
            case 1873746539 : return Long.valueOf(getPlatGbCd());
            case 97915 : return Long.valueOf(getBun());
            ...
            case -1501936433 : return Long.valueOf(getNaMainBun());
            case 1111377838 : return Long.valueOf(getNaSubBun());
            default : return null;
        }
    }
    public void set(String fieldName, Object arg) {
        ...
        switch(hashCode) {
            ...
            case 1873746539 : setPlatGbCd(((Long)arg).longValue());break;
            case 97915 : setBun(((Long)arg).longValue());break;
            ...
            case -1501936433 : setNaMainBun(((Long)arg).longValue());break;
            case 1111377838 : setNaSubBun(((Long)arg).longValue());break;
            default : return;
        }
    }
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hwgi.o28.mem.txGrp_1000.tx_210:Request.umsg";
