...
/**
 * @file              hwgi.o28.mem.txGrp_1000.tx_210.ResponseJSON.java
...
public class ResponseJSON extends com.tmax.promapper.engine.base.JSONMessage implements ResourceMeta {
    ...
    public byte[] marshalObject(Object obj) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_210.Response __root = (hwgi.o28.mem.txGrp_1000.tx_210.Response)obj;
    ...
    public void marshalObject(Object dataObject, JsonGenerator writer) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Response __root = (hwgi.o28.mem.txGrp_1000.tx_210.Response)dataObject;
    ...
    public void marshalJsonBody(hwgi.o28.mem.txGrp_1000.tx_210.Response __root, JsonGenerator writer) throws Exception {
            String strVal;
            int size;
            ...
            size =    __root.sizeBody() < __root.sizeBody() ? __root.sizeBody() : (int)__root.sizeBody();
                         
            if (size == 0) {
                writer.writeNullField("body");
            } else {
                writer.writeArrayFieldStart("body");
            }
            for(int i = 0; i < size; i++) {
                if(__root.getBody(i) != null){
                    hwgi.o28.mem.txGrp_1000.tx_210.BodyJSON bodyMessage = new hwgi.o28.mem.txGrp_1000.tx_210.BodyJSON();
                
                    writer.writeStartObject();
                    bodyMessage.setMasked(this.masked);
                    bodyMessage.marshalJsonBody(__root.getBody(i), writer);
                    writer.writeEndObject();
                } else {
                    writer.writeNull();
                                    }
    ...
    public Object unmarshalObject(byte[] msg, int offset) throws Exception {
        ...
        Object struct = new hwgi.o28.mem.txGrp_1000.tx_210.Response();
    ...
    private void setJsonField_0(JsonParser reader, Object struct, com.tmax.promapper.generator.util.JsonArraySizeValidator arraySizeValidator, String fieldName ) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_210.Response dataObject = (hwgi.o28.mem.txGrp_1000.tx_210.Response)struct;
    ...
    private void setJsonField_5(JsonParser reader, Object struct, com.tmax.promapper.generator.util.JsonArraySizeValidator arraySizeValidator, String fieldName ) throws Exception {
        ...
        while(reader.nextToken() != JsonToken.END_ARRAY) {
            if(!reader.getText().equals("null")) {
                hwgi.o28.mem.txGrp_1000.tx_210.BodyJSON _body = new hwgi.o28.mem.txGrp_1000.tx_210.BodyJSON();
                ...
                dataObject.addBody(body_struct);
            } else {
                dataObject.addBody(null);
            }
        }
    }
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hwgi.o28.mem.txGrp_1000.tx_210:ResponseJSON.msg";
