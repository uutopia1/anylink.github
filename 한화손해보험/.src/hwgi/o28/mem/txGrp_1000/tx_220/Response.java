...
public class Response extends ProMapperDataObject implements ResourceMeta {
    ...
    public void setResultCode(long resultCode, boolean _masked) {
        ...
        private ArrayList<hwgi.o28.mem.txGrp_1000.tx_220.Body> body = new ArrayList<hwgi.o28.mem.txGrp_1000.tx_220.Body>();
    ...
    public void createBody(int _size) {
        ...
        for(int i = body.size(); i < _size; i++) {
            body.add(new hwgi.o28.mem.txGrp_1000.tx_220.Body());
        }
    }
    ...
    public hwgi.o28.mem.txGrp_1000.tx_220.Body[] getBody() {
        return (hwgi.o28.mem.txGrp_1000.tx_220.Body[])body.toArray(new hwgi.o28.mem.txGrp_1000.tx_220.Body[body.size()]);
    }
    public hwgi.o28.mem.txGrp_1000.tx_220.Body getBody(int _index) {
    ...
    public void setBody(int _index, hwgi.o28.mem.txGrp_1000.tx_220.Body body) {
        this.body.set(_index, body);
        _setFlag = true;
    }
    
    public void addBody(int _index, hwgi.o28.mem.txGrp_1000.tx_220.Body body) {
        this.body.add(_index, body);
        _setFlag = true;
    }
    public void addBody(hwgi.o28.mem.txGrp_1000.tx_220.Body body) {
        this.body.add(body);
        _setFlag = true;
    }
    
    public hwgi.o28.mem.txGrp_1000.tx_220.Body removeBody(int _index) {
    ...
    public void clone(proframe.dto.DataObject __response) {
        ...
        for (int index0 = 0; index0 < getBody().length; index0++) {
            _response.addBody(index0, (hwgi.o28.mem.txGrp_1000.tx_220.Body)getBody(index0).clone());
        }
    }
...
/*    static {
        ...
        fieldPropertyMap.put("body"
                            , FieldPropertyFactory.getFieldProperty( FieldProperty.TYPE_ABSTRACT_INCLUDE, -1, "unbounded" , "hwgi.o28.mem.txGrp_1000.tx_220.Body"));
    }*/
