...
/**
 * @file              hwgi.o28.mem.txGrp_1000.tx_220.BodyJSON.java
...
public class BodyJSON extends com.tmax.promapper.engine.base.JSONMessage implements ResourceMeta {
    ...
    public byte[] marshalObject(Object obj) throws Exception {
        ...
        hwgi.o28.mem.txGrp_1000.tx_220.Body __root = (hwgi.o28.mem.txGrp_1000.tx_220.Body)obj;
    ...
    public void marshalObject(Object dataObject, JsonGenerator writer) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_220.Body __root = (hwgi.o28.mem.txGrp_1000.tx_220.Body)dataObject;
    ...
    public void marshalJsonBody(hwgi.o28.mem.txGrp_1000.tx_220.Body __root, JsonGenerator writer) throws Exception {
            String strVal;
            int size;
    ...
    public Object unmarshalObject(byte[] msg, int offset) throws Exception {
        ...
        Object struct = new hwgi.o28.mem.txGrp_1000.tx_220.Body();
    ...
    private void setJsonField_0(JsonParser reader, Object struct, com.tmax.promapper.generator.util.JsonArraySizeValidator arraySizeValidator, String fieldName ) throws Exception {
        hwgi.o28.mem.txGrp_1000.tx_220.Body dataObject = (hwgi.o28.mem.txGrp_1000.tx_220.Body)struct;
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hwgi.o28.mem.txGrp_1000.tx_220:BodyJSON.msg";
