...
public class CommonHeaderXML extends com.tmax.promapper.engine.base.XMLMessage implements ResourceMeta {
    ...
    private void marshalXmlBody_0(hwgi.o28.mem.CommonHeader _commonHeaderXML, XMLStreamWriter writer) throws javax.xml.stream.XMLStreamException, com.tmax.promapper.engine.exception.MarshallException {
        char[] c = null;
            ...
            //element field name is tranCode. nillable="false", minOccurs="1"
        if(_commonHeaderXML.getTranCode() == null) {
            writer.writeStartElement("tranCode");
            if (isRPCEncoded) {
            ...
            if(!_commonHeaderXML.getTranCode(this.masked).equals("")) {
					writer.writeCharacters(_commonHeaderXML.getTranCode(this.masked));
			}
            writer.writeEndElement();
        }
            //element field name is kindCode. nillable="false", minOccurs="1"
        //primitive type
            writer.writeStartElement("kindCode");
            if (isRPCEncoded) {
                writer.writeAttribute(PREFIX_XSI, NS_XSI, "type", "xs:long");
                writer.writeNamespace(PREFIX_SOAP_ENC, URI_NS_SOAP_ENC);
                writer.writeNamespace("xs", "http://www.w3.org/2001/XMLSchema");
            }
        writer.writeCharacters(Long.toString(_commonHeaderXML.getKindCode()));
        writer.writeEndElement();
            //element field name is oprCode. nillable="false", minOccurs="1"
        //primitive type
            writer.writeStartElement("oprCode");
            if (isRPCEncoded) {
                writer.writeAttribute(PREFIX_XSI, NS_XSI, "type", "xs:long");
                writer.writeNamespace(PREFIX_SOAP_ENC, URI_NS_SOAP_ENC);
                writer.writeNamespace("xs", "http://www.w3.org/2001/XMLSchema");
            }
        writer.writeCharacters(Long.toString(_commonHeaderXML.getOprCode()));
        writer.writeEndElement();
            //element field name is sendOrgCode. nillable="false", minOccurs="1"
        if(_commonHeaderXML.getSendOrgCode() == null) {
            writer.writeStartElement("sendOrgCode");
            if (isRPCEncoded) {
                writer.writeAttribute(PREFIX_XSI, NS_XSI, "type", "xs:string");
                writer.writeNamespace(PREFIX_SOAP_ENC, URI_NS_SOAP_ENC);
                writer.writeNamespace("xs", "http://www.w3.org/2001/XMLSchema");
            ...
            if(!_commonHeaderXML.getSendOrgCode(this.masked).equals("")) {
					writer.writeCharacters(_commonHeaderXML.getSendOrgCode(this.masked));
			}
            writer.writeEndElement();
        }
            //element field name is recvOrgCode. nillable="false", minOccurs="1"
        if(_commonHeaderXML.getRecvOrgCode() == null) {
            writer.writeStartElement("recvOrgCode");
            if (isRPCEncoded) {
                writer.writeAttribute(PREFIX_XSI, NS_XSI, "type", "xs:string");
                writer.writeNamespace(PREFIX_SOAP_ENC, URI_NS_SOAP_ENC);
                writer.writeNamespace("xs", "http://www.w3.org/2001/XMLSchema");
            ...
            if(!_commonHeaderXML.getRecvOrgCode(this.masked).equals("")) {
					writer.writeCharacters(_commonHeaderXML.getRecvOrgCode(this.masked));
			}
            writer.writeEndElement();
        }
            //element field name is userId. nillable="false", minOccurs="1"
        if(_commonHeaderXML.getUserId() == null) {
            ...
            if(!_commonHeaderXML.getUserId(this.masked).equals("")) {
					writer.writeCharacters(_commonHeaderXML.getUserId(this.masked));
			}
            writer.writeEndElement();
        }
    }
    ...
    public void marshalObjectExceptRootElement(Object obj, XMLStreamWriter writer) throws Exception {
        ...
        static{
                    //element
            simpleTypeFieldMap.put(new QName("", "tranCode"), 0);
                    //element
            simpleTypeFieldMap.put(new QName("", "kindCode"), 1);
                    //element
            simpleTypeFieldMap.put(new QName("", "oprCode"), 2);
                    //element
            simpleTypeFieldMap.put(new QName("", "sendOrgCode"), 3);
                    //element
            simpleTypeFieldMap.put(new QName("", "recvOrgCode"), 4);
                    //element
            simpleTypeFieldMap.put(new QName("", "userId"), 5);
        ...
        public void setSimpleTypeField_0(QName _argElementName, Integer _argFieldIndex, XMLStreamReader _argReader, hwgi.o28.mem.CommonHeader _argStructure, String value) throws  UnmarshallException, javax.xml.stream.XMLStreamException, Exception {
            ...
            try{
                ...
                case 0:
                    _argStructure.setTranCode(value, this.masked);
                    break;
                case 1:
                    _argStructure.setKindCode(value == null || value.length() == 0 ? 0 : Long.parseLong(value));
                    break;
                case 2:
                    _argStructure.setOprCode(value == null || value.length() == 0 ? 0 : Long.parseLong(value));
                    break;
                case 3:
                    _argStructure.setSendOrgCode(value, this.masked);
                    break;
                case 4:
                    _argStructure.setRecvOrgCode(value, this.masked);
                    break;
                case 5:
                    _argStructure.setUserId(value, this.masked);
                    break;
                default:
