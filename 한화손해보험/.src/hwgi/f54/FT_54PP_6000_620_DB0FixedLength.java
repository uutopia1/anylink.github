...
/**
 * @file              hwgi.f54.FT_54PP_6000_620_DB0FixedLength.java
...
public class FT_54PP_6000_620_DB0FixedLength extends com.tmax.promapper.engine.base.FixedLengthMessage implements ResourceMeta {

    public FT_54PP_6000_620_DB0FixedLength() {
            super(com.tmax.promapper.engine.util.Constants.EUC_KR);
    }

    public FT_54PP_6000_620_DB0FixedLength(int conversionType) {
        super(conversionType);
    }

    public FT_54PP_6000_620_DB0FixedLength(String charsetName) {
        super(charsetName);
    }
    ...
    public byte [] marshalObject(Object obj) throws Exception {
        ...
        hwgi.f54.FT_54PP_6000_620_DB0 __root = (hwgi.f54.FT_54PP_6000_620_DB0)obj;
        ...
        if(__root == null) {
            ...
            /** TEMP */
            flFld.setStringField(this, __root.getTEMP(this.masked), 3, Constants.ALIGN_NON, " ", 0, true, false, Constants.ENCODE_CHAR, null);
    ...
    public Object unmarshalObject(byte[] message, int startOffset) throws Exception{
        hwgi.f54.FT_54PP_6000_620_DB0 dataObject = new hwgi.f54.FT_54PP_6000_620_DB0();
    ...
    public int unmarshalObject(byte[] message, int startOffset, Object dataObject) throws Exception {        
        ...
        hwgi.f54.FT_54PP_6000_620_DB0 __root = (hwgi.f54.FT_54PP_6000_620_DB0)dataObject;
    ...
    private void set_SnrCode(hwgi.f54.FT_54PP_6000_620_DB0 __root, FixedLengthUnmarshalField flFld) throws Exception {
        try {
    ...
    private void set_BlockNo(hwgi.f54.FT_54PP_6000_620_DB0 __root, FixedLengthUnmarshalField flFld) throws Exception {
        try {
    ...
    private void set_SeqNo(hwgi.f54.FT_54PP_6000_620_DB0 __root, FixedLengthUnmarshalField flFld) throws Exception {
        try {
    ...
    private void set_TEMP(hwgi.f54.FT_54PP_6000_620_DB0 __root, FixedLengthUnmarshalField flFld) throws Exception {
        try {

        /** TEMP */
        __root.setTEMP(flFld.getStringField(this, 3, Constants.ALIGN_NON, " ", 0, true, false, Constants.ENCODE_CHAR, Constants.TRIM_NONE), this.masked);
    successFieldCount++;
        } catch(Exception e) {
            StringBuilder esb = new StringBuilder(e.getClass().getName()).append(" [FIELD: TEMP] ");
            if(e.getMessage() != null)
                esb.append(": ").append(e.getMessage());
            throw new Exception(esb.toString(), e);
        }
    ...
    static {
        ...
        fieldPropertyMap.put("TEMP", getProperty_TEMP());
    }
    ...
    private static MessageFieldProperty getProperty_TEMP() {
        MessageFieldProperty fldProp = null;
        fldProp = new MessageFieldProperty("TEMP", "예비", MessageFieldType.STRING, (String)null, null, "3", Constants.ALIGN_NON, " ", 0, true, false, null, null, null, null, null, Constants.TRIM_NONE, Constants.ENCODE_CHAR);
        return fldProp;
    }
