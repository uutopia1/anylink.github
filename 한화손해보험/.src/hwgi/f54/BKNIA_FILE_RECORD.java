...
/**
 * @file              hwgi.f54.BKNIA_FILE_RECORD.java
...
public class BKNIA_FILE_RECORD extends ProMapperDataObject implements ResourceMeta {
    private static final long serialVersionUID= 1L;
    public BKNIA_FILE_RECORD() {
            super();
    }
    ...
    public Object clone() {
        BKNIA_FILE_RECORD copyObj = new BKNIA_FILE_RECORD();
        clone(copyObj);
        return copyObj;
    }
    public void clone(proframe.dto.DataObject __bKNIA_FILE_RECORD) {
        BKNIA_FILE_RECORD _bKNIA_FILE_RECORD = (BKNIA_FILE_RECORD) __bKNIA_FILE_RECORD;
        _bKNIA_FILE_RECORD.setRecord(record);
    }
